...
target_lat2 = 37.525275 #1_dev33.rim
target_lon2 = 139.937851
...
target_lat4 = 37.525355 #4_dev9.rim 5_dev16.rim
target_lon4 = 139.938932
target_lat5 = 37.525310 # 6,7_dev_1.rim
target_lon5 = 139.939045
...
if __name__ == "__main__":
    ...
    #devtext_to_list('device/6_dev1.rim')


    #estimate the alpha and beta
    initialValue = np.array([-55,2])
    r1 = optimize.least_squares(est_ab,initialValue,bounds=([-60,2],[-35,4]),args=(distance,rssi))
    Alpha = r1.x[0]
    Beta = r1.x[1]
